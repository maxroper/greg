...
export const DEFAULT_SITE_CONTENT = {
  ...
  hero: {
    ...
    firstName: "Greg",
    lastName: "Pryor",
    lede: "Former Major Leaguer. World Series Champion. Author. Speaker. I have stories. I'm finally telling them.",
  ...
  contact: {
    ...
    lede: "Press, interviews, autograph requests, baseball questions, or a friendly hello - pick a button.",
    emailCta: "Email Greg",
