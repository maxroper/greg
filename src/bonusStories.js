export const BONUS_STORY_SOURCES = [
  {
    label: "Greg Pryor career stats and biographical data",
    url: "https://www.baseball-almanac.com/players/player.php?p=pryorgr01",
  },
  {
    label: "Yankees grooming policy history",
    url: "https://www.mlb.com/news/yankees-grooming-policy-origins/",
  },
  {
    label: "Reggie Bar history",
    url: "https://baseballhall.org/discover/shortstops-reggie-bar",
  },
  {
    label: "Dan Quisenberry Royals Hall of Fame profile",
    url: "https://www.mlb.com/royals/hall-of-fame/members/dan-quisenberry",
  },
  {
    label: "1985 Kansas City Royals statistics",
    url: "https://www.baseball-reference.com/teams/KCR/1985.shtml",
  },
  {
    label: "1971 MLB draft context",
...
export const BONUS_STORIES = [
  {
    year: "1958",
    title: "The Day I Tried Out At Harris Elementary",
    slug: "harris-elementary-tryout",
    fact: "Greg grew up in Ohio before graduating from Evans High School in Orlando and playing at Florida Southern College.",
    paragraphs: [
  ...
  {
    year: "1967",
    title: "The Day I Got A Scholarship I Did Not Deserve",
    slug: "florida-southern-scholarship",
    fact: "Pryor attended Florida Southern College before Washington drafted him in the sixth round in 1971.",
    paragraphs: [
  ...
  {
    year: "1971",
    title: "The Day I Was Drafted With Brett And Schmidt",
    slug: "same-draft-brett-schmidt",
    fact: "The 1971 draft included future Hall of Famers George Brett, Mike Schmidt, and Jim Rice. Pryor was selected by Washington in the sixth round.",
    paragraphs: [
  ...
  {
    year: "1972",
    title: "The Day Rocky Mount Taught Me Humility",
    slug: "rocky-mount-humility",
    fact: "Before his 1976 debut, Pryor spent more than six seasons in the minor leagues.",
    paragraphs: [
  ...
  {
    year: "1973",
    title: "The Day Gene Locklear Made Syracuse Feel Like Broadway",
    slug: "gene-locklear-syracuse",
    fact: "The old minor leagues were full of long bus rides, veteran characters, and future major leaguers waiting for a call.",
    paragraphs: [
  ...
  {
    year: "1974",
    title: "The Day My Glove Met Hinton",
    slug: "hinton-glove",
    fact: "Pryor eventually played every infield position in the majors, including 377 games at third and 276 at shortstop by Baseball Almanac totals.",
    paragraphs: [
  ...
  {
    year: "1975",
    title: "The Day Amos Otis Corked My Imagination",
    slug: "amos-cork",
    fact: "Amos Otis was a five-time All-Star and a central Royals player before becoming Pryor's teammate in Kansas City.",
    paragraphs: [
  ...
  {
    year: "1976",
    title: "The Day I Got Called Up To The Big Leagues For The First Time",
    slug: "first-call-up",
    fact: "Pryor debuted with the Texas Rangers on June 4, 1976, at age 26.",
    paragraphs: [
  ...
  {
    year: "1976",
    title: "The Day I Made My First Start In Texas",
    slug: "first-start-texas",
    fact: "In his 1976 Rangers stint, Pryor appeared at second base, third base, and shortstop.",
    paragraphs: [
  ...
  {
    year: "1977",
    title: "The Day A Pitcher Tried To Kill Me",
    slug: "pitcher-tried-to-kill-me",
    fact: "Hit-by-pitches have always been part intimidation, part accident, and part clubhouse argument.",
    paragraphs: [
  ...
  {
    year: "1977",
    title: "The Day Gabe Paul, Ed Keating, And Chris Chambliss Changed My Address",
    slug: "gabe-paul-ed-keating-chambliss",
    fact: "The Yankees and Rangers made several mid-1970s transactions while New York was building its late-1970s championship roster.",
    paragraphs: [
  ...
  {
    year: "1977",
    title: "The Day Dale Ford Heard One Too Many Helpful Suggestions",
    slug: "dale-ford",
    fact: "Dale Ford umpired in the American League from the mid-1970s into the 1990s.",
    paragraphs: [
  ...
  {
    year: "1978",
    title: "The Day The Reggie Bar Became A Ground Rule",
    slug: "reggie-bar",
    fact: "On Yankees Opening Day in 1978, fans threw Reggie Bars onto the field after Reggie Jackson homered.",
    paragraphs: [
  ...
  {
    year: "1978",
    title: "The Day Dave Winfield Made The Field Look Smaller",
    slug: "winfield",
    fact: "Dave Winfield was drafted in multiple sports and later became a Hall of Fame outfielder.",
    paragraphs: [
  ...
  {
    year: "1978",
    title: "The Day Ken Coleman Made The Red Sox Sound Like Trouble",
    slug: "ken-coleman-red-sox",
    fact: "Ken Coleman broadcast Cleveland, Cincinnati, and Boston games during a long sportscasting career.",
    paragraphs: [
  ...
  {
    year: "1979",
    title: "The Day Tony La Russa Made A Tape Of My Defense",
    slug: "larussa-defense-tape",
    fact: "Pryor played 143 games for the 1979 White Sox and hit .275, his highest full-season average.",
    paragraphs: [
  ...
  {
    year: "1980",
    title: "The Day I Played The Last Two Games Of The Season",
    slug: "last-two-games-1980",
    fact: "Pryor appeared in 122 games for the 1980 White Sox.",
    paragraphs: [
  ...
  {
    year: "1982",
    title: "The Day I Played First Base For The First Time In Texas",
    slug: "first-base-texas",
    fact: "Pryor played 23 career major league games at first base without an error.",
    paragraphs: [
  ...
  {
    year: "1982",
    title: "The Day Harry Caray Interviewed Me In Anaheim",
    slug: "harry-caray-anaheim",
    fact: "Harry Caray broadcast White Sox games before becoming nationally famous with the Cubs.",
    paragraphs: [
  ...
  {
    year: "1982",
    title: "The Day Piersall And Carew Explained Baseball To Me",
    slug: "piersall-carew",
    fact: "Jimmy Piersall and Rod Carew were known for strong baseball minds, though in very different ways.",
    paragraphs: [
  ...
  {
    year: "1983",
    title: "The Day Dennis DeYoung Made The Clubhouse Sing",
    slug: "dennis-deyoung",
    fact: "Dennis DeYoung was a founding member and lead singer of Styx, whose late-1970s and early-1980s hits filled plenty of clubhouse radios.",
    paragraphs: [
  ...
  {
    year: "1983",
    title: "The Day I Learned Minor Leaguers Were Smarter Than We Looked",
    slug: "minor-league-intelligence",
    fact: "Long minor league apprenticeships were common before modern player development and analytics changed the path.",
    paragraphs: [
  ...
  {
    year: "1984",
    title: "The Day Dan Quisenberry's Shoe Told The Truth",
    slug: "quisenberry-shoe",
    fact: "Dan Quisenberry led the American League in saves five times and set a then-record with 45 saves in 1983.",
    paragraphs: [
  ...
  {
    year: "1985",
    title: "The Day Bobby Grich Made A Seventh-Inning Play",
    slug: "grich-seventh-inning",
    fact: "Bobby Grich was one of the best defensive second basemen of his era and won multiple Gold Gloves.",
    paragraphs: [
  ...
  {
    year: "1985",
    title: "The Day The Caveman Arrived",
    slug: "caveman",
    fact: "Colorful nicknames and clubhouse characters were a major part of 1970s and 1980s baseball culture.",
    paragraphs: [
  ...
  {
    year: "1986",
    title: "The Day My Volare Shoes Had Brass",
    slug: "volare-shoes-brass",
    fact: "Pryor's final major league season was 1986 with Kansas City.",
    paragraphs: [
  ...
  {
    year: "1986",
    title: "The Day I Wrote Thirteen Reasons To Marry Me",
    slug: "thirteen-reasons-married",
    fact: "The real book is dedicated to Greg's wife, Michelle.",
    paragraphs: [
